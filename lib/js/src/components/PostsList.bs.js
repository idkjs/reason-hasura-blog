...
var Post$ReasonHasuraDemo = require("./Post.bs.js");
var Utils$ReasonHasuraDemo = require("../utils.bs.js");
              ...
              className: "flex flex-wrap"
                  ...
                  children: (function (param) {
                      ...
                      if (typeof result === "number") {
                        return Utils$ReasonHasuraDemo.ste("Loading");
                      }
                      if (result.TAG) {
                        var posts = result._0.posts;
                      ...
                      return Utils$ReasonHasuraDemo.ste("Error");
                    })
                }));
}
