...
var Post$ReasonHasuraHooksDevto = require("./Post.bs.js");
var Utils$ReasonHasuraHooksDevto = require("../utils/utils.bs.js");
...
function parse(value) {
  ...
  return {
          posts: value$2 !== undefined ? Js_option.getExn(Js_json.decodeArray(Caml_option.valFromOption(value$2))).map((function (value) {
                  ...
                  })) : Js_exn.raiseError("graphql_ppx: Field posts on type query_root is missing")
        };
}
...
function PostsList(Props) {
  return React.createElement("div", {
            ...
            }, React.createElement(GetPostsSubscription.make, {
                  children: (function (param) {
                      var result = param.result;
                      if (typeof result === "number") {
                        return Utils$ReasonHasuraHooksDevto.ste("Loading");
                      }
                      if (result.tag) {
                        ...
                        return $$Array.map((function (post) {
                                      return React.createElement("div", {
                                                ...
                                                }, React.createElement(Post$ReasonHasuraHooksDevto.make, {
                                                      post: post
                                                    }));
                                    }), posts);
                      }
                      console.log(result[0]);
                      return Utils$ReasonHasuraHooksDevto.ste("Error");
                    })
                }));
}
...
exports.GetPostsSubscription = GetPostsSubscription;
exports.make = make$1;
